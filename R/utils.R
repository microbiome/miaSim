...
#' @param t_start Numeric scalar indicating the initial time of the simulation, default is 0.
#' @param t_end Numeric scalar indicating the final time of the dimulation, default is 1000.
#' @param t_step Numeric scalar indicating the interval between simulation steps, default is 0.1.
#' @param t_store Integer scalar indicating the number of evenly distributed time points to keep, default is 100.
