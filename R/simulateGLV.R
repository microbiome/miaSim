...
#'
#' @param tend Integer scalar indicating timepoints (default: \code{tend = 1000})
#'
#' @param norm Logical scalar \code{TRUE} or \code{FALSE}, return normalised abundances
#'  (proportions in each generation) (default: \code{norm = FALSE})
#'
#' @return
