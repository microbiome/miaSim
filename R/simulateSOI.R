...
#' x <- simulateSOI(n_species = 10, carrying_capacity = 1000, A = A,
...
simulateSOI <- function(
    ...
    propensities <- updatePropensities(carrying_capacity, counts, death_rates,
...
updatePropensities <- function(
    carrying_capacity, #total nr of sites
