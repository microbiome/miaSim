...
This document provides the detailed code required to replicate case study 2.
...
```{r simulateConsumerResource, eval=FALSE}
...
In this part, different visualization of results demonstrate (in various facets) the gradual change of communities' beta diversity.
The first figure indicates that the initial community composition is more important than the combinations of initial available resources.
